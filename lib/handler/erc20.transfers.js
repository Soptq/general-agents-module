...
var EVENT_SIGNATURE = "event Transfer(address indexed from, address indexed to, uint256 amount)";
var Erc20Transfers = /** @class */ (function (_super) {
    __extends(Erc20Transfers, _super);
    function Erc20Transfers(options) {
    ...
    Erc20Transfers.prototype._createFilter = function () {
        var _this = this;
        return function (log) {
            ...
            if (_this.options.amountThreshold !== undefined) {
                if (typeof _this.options.amountThreshold === "function" && !_this.options.amountThreshold(log.args.amount)) {
                    return false;
                }
                if (typeof _this.options.amountThreshold !== "function" && log.args.amount.lt(_this.options.amountThreshold)) {
                    return false;
                }
            }
            return true;
    ...
    Erc20Transfers.prototype.metadata = function (event) {
...
exports.default = Erc20Transfers;
